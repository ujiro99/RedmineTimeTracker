...
(function() {
  $(function() {
    var $buttonIcon, $issueLoading, $issueSelect, AJAX_TIME_OUT, API_KEY, CHARACTERS_MAX, CONTENT_TYPE, HOST, ISSUES, MESSAGE_DURATION, ONE_MINUTE, USER_ID, hours, init, isTracking, loadOpenAssignedIssues, onClickSubmit, onKeyDownComment, postData, setSelectOption, start, submitTimeEntry;
    API_KEY = "ApiKey";
    HOST = "Host";
    USER_ID = "userId";
    ...
    submitTimeEntry = function(host, apiKey, userId, hours) {
      ...
      return $.ajax({
        ...
        success: function(msg) {
          var userMessage, _ref;
          userMessage = "";
          if ((msg != null ? (_ref = msg.time_entry) != null ? _ref.id : void 0 : void 0) != null) {
